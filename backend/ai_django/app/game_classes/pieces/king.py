...
class King(Piece):
    ...
    def calculate_moves(self, board, move_history, player_pieces) -> None:
        ...
        if (
            ...
            self.legal_moves.append(Move(self.loc, two_right, board, SHORT_CASTLE, player_pieces))
        if (
            ...
            self.legal_moves.append(Move(self.loc, two_left, board, LONG_CASTLE, player_pieces))
